...
#data = requests.get('https://covid.ourworldindata.org/data/ecdc/full_data.csv')


def africa_csv_to_df():
...
def africa_df_to_json(df_africa):
    sum_list = []
    for date in df_africa['date']:
    ...
    df_africa_total = sum_list.to_json(orient='index')
